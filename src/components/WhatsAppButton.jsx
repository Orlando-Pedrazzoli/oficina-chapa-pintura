// src/components/WhatsAppButton.jsx - REDONDO COMO CHATBOT
...
const WhatsAppButton = () => {
  ...
  const openWhatsApp = () => {
    const message = `Olá! Gostaria de obter mais informações sobre os vossos serviços de chapa e pintura da Street Paint.`;
  ...
  return (
    <div
      style={{
        position: 'fixed',
        bottom: '20px',
        right: '20px', // WhatsApp fica no canto direito
        zIndex: 1000,
        cursor: 'pointer',
      }}
